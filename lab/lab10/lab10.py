...
# 注意，scheme和python的and返回的都是第一个假值或者最后一个真值！不仅仅是boolean value
def eval_and(expressions):
    ...
    #     val = expressions.first
    #     pointer = expressions.rest
    #     last_val = val
    #     while pointer != nil:
    #         if val is scheme_f:
    #             return scheme_f
...
print(calc_eval(Pair("+", Pair(1, Pair(2, nil)))))
